...
public class DayPlan {
    public static String execute(String userInput, ArrayList<Task> taskList) throws PiggyException {
        ...
        String[] inputParts = userInput.split(" "); // Split into command and date
        if (inputParts.length < 3 || !inputParts[1].equals("for") || inputParts[2].trim().isEmpty()) {
            return "I don't exactly understand what you are asking. Try this format:\n " +
